...
class CounterPolicy
{
    ...
    {
        return $user->hasPermission('VIEW_COUNTERS');
    }
    ...
    {
        return $user->hasPermission('VIEW_COUNTERS') &&
            $user->powerGenerator->id === $counter->generator_id;
    }
    ...
    {
        return $user->hasPermission('UPDATE_COUNTERS') &&
            $user->powerGenerator->id === $counter->generator_id;
    }
    ...
    {
        return $user->hasPermission('DELETE_COUNTERS') &&
            $user->powerGenerator->id === $counter->generator_id;
    }
