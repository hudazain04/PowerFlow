...
//        }
        $permissionGroups = [
            ...
            'Complaints' => [
                ...
                'DELETE_COMPLAINT',
                'VIEW_COMPLAINTS',
                'VIEW_EMPLOYEE_COMPLAINTS',
                'VIEW_USER_COMPLAINTS',
            ],
        ...
        foreach ($guards as $guard) {
            ...
            $adminPermissions = [
                ...
                'VIEW_PLANS', 'VIEW_PLAN_PRICES', 'CREATE_SUBSCRIPTION', 'VIEW_SUBSCRIPTIONS','UPGRADE_SUBSCRIPTION',
                ...
                'VIEW_STATISTICS', 'CREATE_COMPLAINT', 'CREATE_CUSTOMER_COMPLAINT','VIEW_EMPLOYEE_COMPLAINTS','VIEW_USER_COMPLAINTS',
                'UPDATE_COMPLAINT', 'DELETE_COMPLAINT', 'VIEW_COMPLAINTS', 'VIEW_PROFILE', 'UPDATE_PROFILE', 'PROCESS_STRIPE_PAYMENT',
                ...
                'SEND_NOTIFICATION','VIEW_NOTIFICATIONS','VIEW_NOTIFICATION','READ_NOTIFICATIONS','VIEW_SPENDING_PAYMENTS','VIEW_EMPLOYEE_ACTIONS',
            ];
            ...
            $employeePermissions = [
                ...
                'VIEW_ABOUT_APP', 'VIEW_TERMS_CONDITIONS', 'VIEW_PRIVACY_POLICY',
                'CREATE_COMPLAINT', 'CREATE_CUSTOMER_COMPLAINT', 'VIEW_COMPLAINTS','VIEW_EMPLOYEE_COMPLAINTS','UPDATE_COMPLAINT',
                ...
                'UPDATE_ACTION', 'APPROVE_ACTION', 'REJECT_ACTION', 'VIEW_ACTION', 'VIEW_ACTIONS','VIEW_EMPLOYEE_ACTIONS',
            ];
            ...
            $userPermissions = [
                ...
                'VIEW_TERMS_CONDITIONS', 'VIEW_PRIVACY_POLICY', 'CREATE_CUSTOMER_COMPLAINT','VIEW_USER_COMPLAINTS',
                'VIEW_PROFILE', 'UPDATE_PROFILE', 'PROCESS_STRIPE_PAYMENT',
                'PROCESS_CASH_PAYMENT','PROCESS_STRIPE_SPENDING_PAYMENT' ,'PROCESS_CACHE_SPENDING_PAYMENT',
                'VIEW_PLANS', 'VIEW_PLAN_PRICES','GET_SPENDINGS','VIEW_NOTIFICATIONS','VIEW_NOTIFICATION','READ_NOTIFICATIONS','VIEW_FAQ',
