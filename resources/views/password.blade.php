...
<div class="min-h-screen flex items-center justify-center bg-gray-100">
    <div class="bg-white p-8 rounded-lg shadow-md text-center max-w-md w-full" role="alert">
        ...
        @else
            ...
            <h1 class="text-2xl font-bold text-gray-800 mt-4">{{ __('Your Request is Verified Successfully!') }}</h1>
            <p class="text-gray-600 mt-2">{{ __('Your Request has been successfully verified.') }}</p>
        @endif
